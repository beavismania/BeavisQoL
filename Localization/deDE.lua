...
BeavisQoL.Localization.deDE = {
	...
	NAVIGATION_HINT = "Allgemein und Module",
	GENERAL = "Allgemein",
	MODULES = "Module",
	HOME = "Startseite",
	...
	WELCOME_SUBTITLE = "Dein Addon-Hub für mehr Übersicht",
	WELCOME_BODY = "Beavis Quality of Life sammelt kleine und große Alltagshelfer an einem Ort: Tracker, Weekly-Ansichten, Komfortfunktionen und UI-Module, die sich bewusst leicht anfühlen sollen.\n\nDie Startseite ist deshalb keine trockene Einstellungswand, sondern ein ruhiger Einstieg mit den wichtigsten Wegen und einem schnellen Überblick über das Projekt.",
	PROJECT_STATUS = "Projektstatus",
	STATUS_ALPHA = "Status: Alpha, aktiv im Ausbau",
	STATUS_FOCUS = "Fokus: klare Tracker, schnellere Komfortwege und eine aufgeräumte zentrale Oberfläche.",
	...
	COMFORT_CARD_BODY = "Komfort-Module nehmen repetitive Handgriffe aus dem Alltag heraus: Looten, Reparieren, Verkauf und kleine UI-Helfer sollen einfach nebenbei funktionieren.",
	...
	DISCORD_BODY = "Feedback, Ideen und Support landen am besten gesammelt über die Website bzw. den Discord. So fließt direkt zurück, was im Alltag stört oder noch fehlt.",
	DISCORD_FOOTER = "Zur Beavismania-Website",
	DISCORD_POPUP = "Beavismania öffnen",

	FOOTER_TEXT = "Ziel dieser Oberfläche: weniger gequetschte Listen, mehr klare Flächen, schnellere Orientierung und genug Raum, damit neue Module später organisch hineinwachsen können.",
