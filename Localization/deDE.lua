...
BeavisQoL.Localization.deDE = {
	...
	AUCTION_HOUSE_DESC = "Aktiviert im Auktionshaus auf Wunsch automatisch den Filter für die aktuelle Erweiterung.",
	AUCTION_HOUSE_CURRENT_EXPANSION_FILTER = "Nur aktuelle Erweiterung automatisch aktivieren",
	AUCTION_HOUSE_CURRENT_EXPANSION_FILTER_HINT = "Setzt beim Öffnen des Blizzard-Auktionshauses automatisch den Filter \"Nur aktuelle Erweiterung\", sobald die Auswahl sichtbar ist.",
