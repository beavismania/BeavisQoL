...
BeavisQoL.Localization.deDE = {
	...
	CURRENCY_SEARCH_HINT = "Fügt dem Blizzard-Währungsfenster ein Suchfeld hinzu und blendet sichtbare Währungszeilen passend zur Suche direkt ein oder aus.",
	CHAT_LINK_COPY = "Chat-Link Kopieren",
	CHAT_LINK_COPY_HINT = "Erkennt `http://` und `https://` im Chat, macht sie klickbar und öffnet beim Klick ein Kopierfenster mit der URL.",
	CHAT_LINK_COPY_POPUP_TITLE = "Chat-Link kopieren",
	CURRENCY_SEARCH_RESULTS_TITLE = "Trefferliste",
	CURRENCY_SEARCH_NO_RESULTS = "Keine passenden Währungen in der aktuellen Ansicht gefunden.",
	CURRENCY_SEARCH_WAITING_FOR_DATA = "Kontoweite Währungsdaten werden noch geladen...",
	CURRENCY_SEARCH_UNAVAILABLE = "Die Blizzard-Währungsliste ist gerade nicht verfügbar.",
	CURRENCY_SEARCH_PREVIEW_NOTE = "Nur Vorschau. Auswahl und Überweisen bleiben im Blizzard-Währungsfenster.",
	...
	TALENT_LOADOUT_REMINDER_WARNING = "Readycheck Info",
	...
	PREY_HUNT_PROGRESS_HINT = "Blendet bei einer aktiven Midnight-Beutejagd den aktuellen Fortschritt in Prozent direkt am Blizzard-Beutejagd-Symbol ein.",
	PREY_HUNT_PERCENT_FORMAT = "%d%%",
...
{HC} HC-spezifische Änderungen sind derzeit unspezifiziert; in den priorisierten Quellen war keine verifizierbare HC-exklusive Änderungsliste auffindbar.
	...
	STREAMER_PLANNER_SPEC_PROMPT_TITLE = "Rolle auswählen",
	STREAMER_PLANNER_SPEC_PROMPT_HINT = "Jemand möchte per !enter in die Planung. Wähle die Rolle aus, damit der passende Slot gesetzt wird.",
