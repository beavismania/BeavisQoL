...
BeavisQoL.Localization.deDE = {
	...
	MINIMAP_CTRL_CLICK = "Strg-Klick: Minimap-HUD umschalten",
	...
	TALENT_FRAME_SCALE_HINT = "Aktiviert die Skalierung fuer das Blizzard-Talentfenster. Den Wert kannst du direkt hier anpassen oder spaeter ueber den kleinen Prozent-Button im Talentfenster.",
	TALENT_FRAME_SCALE_BUTTON_TOOLTIP = "Talentfenster skalieren",
	TALENT_FRAME_SCALE_BUTTON_TOOLTIP_HINT = "Oeffnet ein separates Skalierungsfenster. Darin kannst du auch das Talentfenster fixieren oder zum Verschieben freigeben.",
	...
	TALENT_FRAME_SCALE_WINDOW_LOCK_TOOLTIP_HINT = "Wenn geloest, kannst du das Talentfenster direkt oben greifen und die Position wird gespeichert.",
	...
	MINIMAP_HUD_HINT = "Zieht die Live-Minimap gross und transparent in die Bildschirmmitte. Rahmen, Buttons und der Minimap-Sammler bleiben dabei oben rechts.",
	MINIMAP_HUD_TOGGLE = "HUD umschalten",
	MINIMAP_HUD_TOGGLE_HINT = "Oeffnet oder schliesst die grosse HUD-Ansicht in der Bildschirmmitte.",
	MINIMAP_HUD_OPEN = "HUD oeffnen",
	MINIMAP_HUD_CLOSE = "HUD schliessen",
	MINIMAP_HUD_SIZE = "HUD-Groesse",
    MINIMAP_HUD_MAP_ALPHA = "Karten-Transparenz",
	MINIMAP_HUD_COORDS = "Koordinaten anzeigen",
	MINIMAP_HUD_MOUSE = "Minimap-Maus aktivieren",
	MINIMAP_HUD_MOUSE_HINT = "Wenn aktiv, kannst du im HUD ueber Knoten hovern. Klicks in die Spielwelt innerhalb des HUDs werden dann aber blockiert.",
	MINIMAP_HUD_TOPRIGHT_MINIMAP = "Rahmen und Buttons bleiben oben rechts",
	MINIMAP_HUD_TOPRIGHT_MINIMAP_HINT = "In der Mitte erscheint nur die vergroesserte Scan-Karte. Der normale Minimap-Rahmen und der Minimap-Sammler bleiben oben rechts an ihrem Platz.",
...
{HC} HC-spezifische Änderungen sind derzeit unspezifiziert; in den priorisierten Quellen war keine verifizierbare HC-exklusive Änderungsliste auffindbar.
	...
	EASY_LFG_TEXT_SCALE_HINT = "Passt nur die SchriftgrÃ¶ÃŸe im Easy-LFG-Overlay an, unabhÃ¤ngig von der FenstergrÃ¶ÃŸe.",
