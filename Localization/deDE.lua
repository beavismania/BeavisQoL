...
BeavisQoL.Localization.deDE = {
	...
	FISHING_HELPER_DESC = "Ein Ein-Tasten-Modul zum bequemen Angeln.",
	FISHING_HELPER_USAGE_HINT = "",
	FISHING_HELPER_ENABLE = "Bequem Angeln aktivieren",
	...
	MINIMAP_COLLECTOR_BUTTONS_HINT = "Im Dropdown legst du pro Addon fest, ob es gesammelt, an der Minimap gelassen oder ausgeblendet wird.",
