...
BeavisQoL.Localization.deDE = {
	...
	KEYSTONE_ACTIONS_HINT = "Ersetzt im Mythic+-Schlüsselsteinfenster den Aktivieren-Button durch Bereitschaftscheck, Start und Timerstart. Mit Auto-Timer startet der Timerstart automatisch, sobald nach deinem Bereitschaftscheck alle bereit sind.",
	KEYSTONE_ACTIONS_GROUP_LOCK = "Knöpfe nur in Gruppe aktiv",
	KEYSTONE_ACTIONS_GROUP_LOCK_HINT = "Wenn aktiv, bleiben Bereitschaftscheck, Start und Timerstart außerhalb einer Gruppe gesperrt.",
	KEYSTONE_ACTIONS_SECONDS = "Timer-Sekunden:",
	KEYSTONE_ACTIONS_SECONDS_HINT = "Gilt für Timerstart und Auto-Timer. Zulässig sind 1 bis 30 Sekunden.",
	KEYSTONE_ACTIONS_AUTOTIMER = "Auto-Timer",
	KEYSTONE_ACTIONS_READYCHECK = "Bereitschaft",
	KEYSTONE_ACTIONS_START = "Start",
	KEYSTONE_ACTIONS_PULLTIMER = "Timerstart",
