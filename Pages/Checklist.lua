...
local function CreateBuiltInTodoRow(parent)
    ...
    enabledLabel:SetFont("Fonts\\FRIZQT__.TTF", 11, "")
...
TrackerTitle:SetFont("Fonts\\FRIZQT__.TTF", 12, "OUTLINE")
...
TrackerBuiltInHeader:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
TrackerBuiltInHeader:SetTextColor(1, 0.82, 0, 1)
TrackerBuiltInHeader:Hide()

TrackerManualHeader = TrackerContent:CreateFontString(nil, "OVERLAY")
TrackerManualHeader:SetJustifyH("LEFT")
TrackerManualHeader:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
TrackerManualHeader:SetTextColor(1, 0.82, 0, 1)
TrackerManualHeader:Hide()

TrackerWatchHeader = TrackerContent:CreateFontString(nil, "OVERLAY")
TrackerWatchHeader:SetJustifyH("LEFT")
TrackerWatchHeader:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
TrackerWatchHeader:SetTextColor(1, 0.82, 0, 1)
TrackerWatchHeader:Hide()
...
TrackerEmptyText:SetFont("Fonts\\FRIZQT__.TTF", 11, "")
TrackerEmptyText:SetPoint("TOPLEFT", TrackerContent, "TOPLEFT", 8, -8)
...
TrackerAddPopupTitle:SetFont("Fonts\\FRIZQT__.TTF", 13, "OUTLINE")
TrackerAddPopupTitle:SetTextColor(1, 0.82, 0, 1)
...
TrackerAddPopupHint:SetFont("Fonts\\FRIZQT__.TTF", 11, "")
...
IntroTitle:SetText(L("CHECKLIST"))
...
IntroSummaryValue:SetFont("Fonts\\FRIZQT__.TTF", 16, "OUTLINE")
IntroSummaryValue:SetTextColor(1, 0.82, 0, 1)
...
IntroHint:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
...
WatchBg:SetColorTexture(0.07, 0.07, 0.07, 0.92)
...
WatchBorder:SetColorTexture(1, 0.82, 0, 0.9)

local WatchTitle = WatchPanel:CreateFontString(nil, "OVERLAY")
WatchTitle:SetPoint("TOPLEFT", WatchPanel, "TOPLEFT", 18, -14)
WatchTitle:SetFont("Fonts\\FRIZQT__.TTF", 16, "OUTLINE")
WatchTitle:SetTextColor(1, 0.82, 0, 1)
...
WatchEmptyText:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
...
DailyBg:SetColorTexture(0.07, 0.07, 0.07, 0.92)
...
DailyBorder:SetColorTexture(1, 0.82, 0, 0.9)

local DailyTitle = DailyPanel:CreateFontString(nil, "OVERLAY")
DailyTitle:SetPoint("TOPLEFT", DailyPanel, "TOPLEFT", 18, -14)
DailyTitle:SetFont("Fonts\\FRIZQT__.TTF", 16, "OUTLINE")
DailyTitle:SetTextColor(1, 0.82, 0, 1)
...
DailyEmptyText:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
...
WeeklyBg:SetColorTexture(0.07, 0.07, 0.07, 0.92)
...
WeeklyBorder:SetColorTexture(1, 0.82, 0, 0.9)

local WeeklyTitle = WeeklyPanel:CreateFontString(nil, "OVERLAY")
WeeklyTitle:SetPoint("TOPLEFT", WeeklyPanel, "TOPLEFT", 18, -14)
WeeklyTitle:SetFont("Fonts\\FRIZQT__.TTF", 16, "OUTLINE")
WeeklyTitle:SetTextColor(1, 0.82, 0, 1)
...
WeeklyEmptyText:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
...
ManualControlBg:SetColorTexture(0.07, 0.07, 0.07, 0.92)
...
ManualControlBorder:SetColorTexture(1, 0.82, 0, 0.9)
...
ManualControlTitle:SetFont("Fonts\\FRIZQT__.TTF", 16, "OUTLINE")
ManualControlTitle:SetTextColor(1, 0.82, 0, 1)
...
ManualControlHint:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
ManualControlHint:SetTextColor(0.80, 0.80, 0.80, 1)
...
ManualAddLabel:SetTextColor(1, 0.82, 0, 1)
...
ManualCategoryHint:SetFont("Fonts\\FRIZQT__.TTF", 11, "")
...
TrackerHideCompletedLabel:SetFont("Fonts\\FRIZQT__.TTF", 14, "")
TrackerHideCompletedLabel:SetTextColor(1, 1, 1, 1)
...
TrackerHideCompletedHint:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
