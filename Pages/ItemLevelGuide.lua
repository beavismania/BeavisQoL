...
local function CreatePanelSurface(frame, accentKey, isHero)
    ...
    topGlow:SetHeight(isHero and 44 or 34)
    ...
    sideAccent:SetPoint("TOPLEFT", frame, "TOPLEFT", 0, -18)
    sideAccent:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", 0, 18)
...
local function CreateCard(parent, accentKey, eyebrowText, titleText, subtitleText)
    ...
    frame.HeaderInset = subtitleText and subtitleText ~= "" and 72 or 56
    frame.BottomInset = 18

    CreatePanelSurface(frame, accentKey, false)

    local eyebrow = frame:CreateFontString(nil, "OVERLAY")
    eyebrow:SetPoint("TOPLEFT", frame, "TOPLEFT", 18, -14)
    eyebrow:SetFont("Fonts\\FRIZQT__.TTF", 10, "OUTLINE")
    ...
    if subtitleText and subtitleText ~= "" then
        ...
        subtitle:SetPoint("RIGHT", frame, "RIGHT", -18, 0)
    ...
    body:SetPoint("TOPLEFT", frame, "TOPLEFT", 18, -frame.HeaderInset)
    body:SetPoint("TOPRIGHT", frame, "TOPRIGHT", -18, -frame.HeaderInset)
    body:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", 18, frame.BottomInset)
    body:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -18, frame.BottomInset)
    frame.Body = body
...
local function SetCardFootnote(card, text, colorKey)
    ...
    note:SetPoint("BOTTOMLEFT", card, "BOTTOMLEFT", 18, 12)
    note:SetPoint("RIGHT", card, "RIGHT", -18, 0)
    ...
    card.Body:SetPoint("TOPLEFT", card, "TOPLEFT", 18, -card.HeaderInset)
    card.Body:SetPoint("TOPRIGHT", card, "TOPRIGHT", -18, -card.HeaderInset)
    card.Body:SetPoint("BOTTOMLEFT", card, "BOTTOMLEFT", 18, card.BottomInset)
    card.Body:SetPoint("BOTTOMRIGHT", card, "BOTTOMRIGHT", -18, card.BottomInset)
end
...
local function CreateTable(parent, columns, rows, options)
    ...
    function frame:UpdateLayout()
        ...
        for columnIndex, header in ipairs(self.Headers) do
            ...
            header:SetPoint("TOPLEFT", self, "TOPLEFT", bounds.left + 8, -7)
            header:SetWidth(math.max(1, bounds.width - 16))
        ...
        for rowIndex, rowFrame in ipairs(self.Rows) do
            ...
            for columnIndex, cell in ipairs(rowFrame.Cells) do
                local bounds = columnBounds[columnIndex]
                cell:ClearAllPoints()
                cell:SetPoint("LEFT", rowFrame, "LEFT", bounds.left + 8, 0)
                cell:SetWidth(math.max(1, bounds.width - 16))
...
HeroEyebrow:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
...
HeroTitle:SetPoint("RIGHT", HeroPanel, "RIGHT", -220, 0)
HeroTitle:SetJustifyH("LEFT")
HeroTitle:SetFont("Fonts\\FRIZQT__.TTF", 28, "OUTLINE")
...
HeroSubtitle:SetPoint("RIGHT", HeroPanel, "RIGHT", -220, 0)
HeroSubtitle:SetJustifyH("LEFT")
HeroSubtitle:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
...
HeroDescription:SetPoint("TOPLEFT", HeroSubtitle, "BOTTOMLEFT", 0, -12)
HeroDescription:SetPoint("RIGHT", HeroPanel, "RIGHT", -220, 0)
HeroDescription:SetJustifyH("LEFT")
HeroDescription:SetJustifyV("TOP")
HeroDescription:SetFont("Fonts\\FRIZQT__.TTF", 12, "")
...
SeasonBadgeLabel:SetPoint("TOPLEFT", SeasonBadge, "TOPLEFT", 16, -16)
SeasonBadgeLabel:SetPoint("RIGHT", SeasonBadge, "RIGHT", -12, 0)
SeasonBadgeLabel:SetJustifyH("LEFT")
SeasonBadgeLabel:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
...
SeasonBadgeTitle:SetFont("Fonts\\FRIZQT__.TTF", 22, "OUTLINE")
...
SeasonBadgeText:SetPoint("TOPLEFT", SeasonBadgeTitle, "BOTTOMLEFT", 0, -8)
SeasonBadgeText:SetPoint("RIGHT", SeasonBadge, "RIGHT", -12, 0)
SeasonBadgeText:SetJustifyH("LEFT")
SeasonBadgeText:SetFont("Fonts\\FRIZQT__.TTF", 11, "")
...
LegendLine:SetPoint("BOTTOMLEFT", HeroPanel, "BOTTOMLEFT", 22, 16)
LegendLine:SetPoint("RIGHT", HeroPanel, "RIGHT", -220, 0)
LegendLine:SetJustifyH("LEFT")
LegendLine:SetFont("Fonts\\FRIZQT__.TTF", 11, "OUTLINE")
...
local UpgradeTable = CreateTable(
    UpgradeCard.Body,
    {
        { title = "ilvl", width = 0.15, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_PATH_RANK"), width = 0.44, justify = "LEFT" },
        { title = L("ITEM_GUIDE_HEADER_CRESTS"), width = 0.41, justify = "LEFT" },
    },
    UPGRADE_ROWS,
    { rowHeight = 23, headerHeight = 28, cellFontSize = 11, headerFontSize = 12 }
)
...
local CraftedTable = CreateTable(
    CraftedCard.Body,
    {
        { title = L("ITEM_GUIDE_HEADER_QUALITY"), width = 0.18, justify = "CENTER" },
        { title = L("ITEM_GUIDE_ABBR_ADVENTURER"), width = 0.16, justify = "CENTER" },
        { title = L("ITEM_GUIDE_ABBR_VETERAN"), width = 0.16, justify = "CENTER" },
        { title = L("ITEM_GUIDE_ABBR_CHAMPION"), width = 0.18, justify = "CENTER" },
        { title = L("ITEM_GUIDE_ABBR_HERO"), width = 0.16, justify = "CENTER" },
        { title = L("ITEM_GUIDE_ABBR_MYTH"), width = 0.16, justify = "CENTER" },
    },
    CRAFTED_ROWS,
    { rowHeight = 26, headerHeight = 28, cellFontSize = 12, headerFontSize = 11 }
)
...
local DungeonTable = CreateTable(
    DungeonCard.Body,
    {
        { title = L("ITEM_GUIDE_HEADER_SOURCE"), width = 0.28, justify = "LEFT" },
        { title = L("ITEM_GUIDE_HEADER_END_REWARD"), width = 0.32, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_GREAT_VAULT"), width = 0.40, justify = "CENTER" },
    },
    DUNGEON_ROWS,
    { rowHeight = 25, headerHeight = 28, cellFontSize = 12, headerFontSize = 11 }
)
...
local RaidTable = CreateTable(
    RaidCard.Body,
    {
        { title = L("ITEM_GUIDE_HEADER_DIFFICULTY"), width = 0.48, justify = "LEFT" },
        { title = L("ITEM_GUIDE_HEADER_EARLY"), width = 0.13, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_MID"), width = 0.13, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_LATE"), width = 0.13, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_END"), width = 0.13, justify = "CENTER" },
    },
    RAID_ROWS,
    { rowHeight = 28, headerHeight = 28, cellFontSize = 12, headerFontSize = 11 }
)
...
local DelveTable = CreateTable(
    DelveCard.Body,
    {
        { title = L("ITEM_GUIDE_HEADER_LEVEL"), width = 0.16, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_END_REWARD"), width = 0.30, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_MAP_DROP"), width = 0.26, justify = "CENTER" },
        { title = L("ITEM_GUIDE_HEADER_GREAT_VAULT"), width = 0.28, justify = "CENTER" },
    },
    DELVE_ROWS,
    { rowHeight = 25, headerHeight = 28, cellFontSize = 12, headerFontSize = 11 }
)
...
FooterText:SetFont("Fonts\\FRIZQT__.TTF", 11, "")
...
BeavisQoL.UpdateItemLevelGuide = function()
    ...
    SetTableHeaders(CraftedTable, {
        ...
        L("ITEM_GUIDE_ABBR_ADVENTURER"),
        L("ITEM_GUIDE_ABBR_VETERAN"),
        L("ITEM_GUIDE_ABBR_CHAMPION"),
        L("ITEM_GUIDE_ABBR_HERO"),
        L("ITEM_GUIDE_ABBR_MYTH"),
    })
...
local function ApplyCardHeight(card, tableFrame)
    card:SetHeight(card.HeaderInset + tableFrame.RequiredHeight + card.BottomInset + 2)
end
...
local function LayoutWide(contentWidth)
    ...
    local leftWidth = math.floor(workingWidth * 0.42)
    local rightWidth = workingWidth - leftWidth - columnGap
    local middleWidth = math.floor((rightWidth - columnGap) / 2)
    local rightColumnWidth = rightWidth - middleWidth - columnGap
    local tallestColumnHeight = math.max(
        UpgradeCard:GetHeight(),
        CraftedCard:GetHeight() + 18 + DungeonCard:GetHeight(),
        RaidCard:GetHeight() + 18 + DelveCard:GetHeight()
    )
    ...
    HeroPanel:SetHeight(168)
    SeasonBadge:ClearAllPoints()
    SeasonBadge:SetPoint("TOPRIGHT", HeroPanel, "TOPRIGHT", -20, -18)

    UpgradeCard:ClearAllPoints()
    UpgradeCard:SetPoint("TOPLEFT", HeroPanel, "BOTTOMLEFT", 0, -18)
    ...
    DungeonCard:SetPoint("TOPLEFT", CraftedCard, "BOTTOMLEFT", 0, -18)
    DungeonCard:SetWidth(middleWidth)

    DelveCard:ClearAllPoints()
    DelveCard:SetPoint("TOPLEFT", RaidCard, "BOTTOMLEFT", 0, -18)
    DelveCard:SetWidth(rightColumnWidth)

    FooterPanel:ClearAllPoints()
    FooterPanel:SetPoint("TOPLEFT", HeroPanel, "BOTTOMLEFT", 0, -(18 + tallestColumnHeight + 18))
    FooterPanel:SetPoint("TOPRIGHT", HeroPanel, "BOTTOMRIGHT", 0, -(18 + tallestColumnHeight + 18))
    FooterPanel:SetHeight(62)

    PageContent:SetHeight(HeroPanel:GetHeight() + tallestColumnHeight + FooterPanel:GetHeight() + 94)
end
...
local function LayoutMedium(contentWidth)
    ...
    local topY = -20
    local workingWidth = contentWidth - (outerGap * 2)
    local leftWidth = math.floor((workingWidth - columnGap) / 2)
    local rightWidth = workingWidth - leftWidth - columnGap
    local firstRowHeight = math.max(CraftedCard:GetHeight(), RaidCard:GetHeight())
    local secondRowHeight = math.max(DungeonCard:GetHeight(), DelveCard:GetHeight())

    HeroPanel:SetPoint("TOPLEFT", PageContent, "TOPLEFT", outerGap, topY)
    HeroPanel:SetPoint("TOPRIGHT", PageContent, "TOPRIGHT", -outerGap, topY)
    HeroPanel:SetHeight(184)
    SeasonBadge:ClearAllPoints()
    SeasonBadge:SetPoint("TOPRIGHT", HeroPanel, "TOPRIGHT", -18, -18)

    UpgradeCard:ClearAllPoints()
    UpgradeCard:SetPoint("TOPLEFT", HeroPanel, "BOTTOMLEFT", 0, -18)
    UpgradeCard:SetPoint("TOPRIGHT", HeroPanel, "BOTTOMRIGHT", 0, -18)

    CraftedCard:ClearAllPoints()
    CraftedCard:SetPoint("TOPLEFT", UpgradeCard, "BOTTOMLEFT", 0, -18)
    ...
    FooterPanel:ClearAllPoints()
    FooterPanel:SetPoint("TOPLEFT", HeroPanel, "BOTTOMLEFT", 0, -(18 + UpgradeCard:GetHeight() + 18 + firstRowHeight + 18 + secondRowHeight + 18))
    FooterPanel:SetPoint("TOPRIGHT", HeroPanel, "BOTTOMRIGHT", 0, -(18 + UpgradeCard:GetHeight() + 18 + firstRowHeight + 18 + secondRowHeight + 18))
    FooterPanel:SetHeight(62)
...
local function LayoutNarrow(contentWidth)
    ...
    HeroPanel:SetPoint("TOPLEFT", PageContent, "TOPLEFT", outerGap, topY)
    HeroPanel:SetPoint("TOPRIGHT", PageContent, "TOPRIGHT", -outerGap, topY)
    HeroPanel:SetHeight(214)
    SeasonBadge:ClearAllPoints()
    SeasonBadge:SetPoint("TOPRIGHT", HeroPanel, "TOPRIGHT", -16, -16)
    ...
    FooterPanel:ClearAllPoints()
    FooterPanel:SetPoint("TOPLEFT", DelveCard, "BOTTOMLEFT", 0, -gap)
    FooterPanel:SetPoint("TOPRIGHT", DelveCard, "BOTTOMRIGHT", 0, -gap)
...
function LayoutPage()
    ...
    -- Schwellen stark erhöht, damit das vertikale Layout fast immer greift
    if contentWidth >= 1600 then
        LayoutWide(contentWidth)
    elseif contentWidth >= 1300 then
