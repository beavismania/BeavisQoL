...
local function CreateTimerBar(parentFrame)
    ...
    borderTop:SetColorTexture(0.88, 0.72, 0.46, 0.78)
    ...
    borderBottom:SetColorTexture(0.88, 0.72, 0.46, 0.52)
    ...
    borderLeft:SetColorTexture(0.88, 0.72, 0.46, 0.52)
    ...
    borderRight:SetColorTexture(0.88, 0.72, 0.46, 0.52)
