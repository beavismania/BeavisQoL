...
local function EnsureOverlayFrame()
    ...
    topBorder:SetColorTexture(0.88, 0.72, 0.46, 0.12)
    ...
    bottomBorder:SetColorTexture(0.88, 0.72, 0.46, 0.12)
    ...
    leftBorder:SetColorTexture(0.88, 0.72, 0.46, 0.06)
    ...
    rightBorder:SetColorTexture(0.88, 0.72, 0.46, 0.06)
    ...
    timerBarBorder:SetColorTexture(0.88, 0.72, 0.46, 0.16)
