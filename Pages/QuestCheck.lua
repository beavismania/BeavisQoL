...
QuestCheckMinimapContextLabel:SetTextColor(0.95, 0.91, 0.85, 1)
...
QuestCheckMinimapContextHint:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
...
SearchBg:SetColorTexture(0.1, 0.068, 0.046, 0.94)
...
SearchBorder:SetColorTexture(0.88, 0.72, 0.46, 0.82)

local SearchTitle = SearchPanel:CreateFontString(nil, "OVERLAY")
SearchTitle:SetPoint("TOPLEFT", SearchPanel, "TOPLEFT", 18, -14)
SearchTitle:SetFont("Fonts\\FRIZQT__.TTF", 15, "OUTLINE")
SearchTitle:SetTextColor(1, 0.88, 0.62, 1)
...
SearchHint:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
SearchHint:SetTextColor(0.78, 0.74, 0.69, 1)
...
SearchProgressText:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
SearchProgressText:SetTextColor(0.78, 0.74, 0.69, 1)
...
SearchLinkHint:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
...
ResultBg:SetColorTexture(0.1, 0.068, 0.046, 0.94)
...
ResultBorder:SetColorTexture(0.88, 0.72, 0.46, 0.82)

local ResultTitle = ResultPanel:CreateFontString(nil, "OVERLAY")
ResultTitle:SetPoint("TOPLEFT", ResultPanel, "TOPLEFT", 18, -14)
ResultTitle:SetFont("Fonts\\FRIZQT__.TTF", 15, "OUTLINE")
ResultTitle:SetTextColor(1, 0.88, 0.62, 1)
...
ResultStateValue:SetFont("Fonts\\FRIZQT__.TTF", 18, "OUTLINE")
ResultStateValue:SetTextColor(1, 0.88, 0.62, 1)
...
ResultText:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
ResultText:SetTextColor(0.95, 0.91, 0.85, 1)
ResultText:SetText("")
...
ResultListText:SetFont("Fonts\\FRIZQT__.TTF", 13, "")
