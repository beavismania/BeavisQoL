...
Ein World of Warcraft Addon fuer Retail, das kleine und praktische Quality-of-Life-Funktionen an einem Ort sammelt.
...
Dieses Addon ist mein erstes eigenes WoW-Addon und gleichzeitig ein kleines Lernprojekt, mit dem ich Schritt fuer Schritt **Lua** und die Entwicklung von WoW-Addons besser verstehen moechte.

Das Ziel ist nicht, alles auf einmal zu bauen, sondern nach und nach sinnvolle Funktionen zu ergaenzen, sauberer zu strukturieren und dabei immer besser zu werden.
...
- Oeffnen ueber `/beavis`
- Minimap-Button zum schnellen Oeffnen
...
- **Pet Stuff:** `Auto Respawn Pet` beschwoert dein zuletzt aktives Begleiter-Pet erneut
- **LFG:** Zeigt Laenderflaggen in der Premade-Gruppensuche auf Basis des Realms an
- **Combat Text:** Passt Blizzard-Kampftext optisch an, inklusive Schriftart und Bewegungsverhalten

## Installation

### Manuell ueber GitHub

Wichtig:
Wenn du das Addon als ZIP laden willst, nutze nach Moeglichkeit die Datei aus den GitHub Releases:

https://github.com/beavismania/BeavisQoL/releases

Der normale GitHub-Quellcode-Download ueber `Code` -> `Download ZIP` erzeugt immer einen Ordnernamen wie `BeavisQoL-main`.
...
3. Darauf achten, dass der Ordner am Ende **`BeavisQoL`** heisst.
...
- Alternativ ueber den Minimap-Button

Im Addon-Fenster findest du die einzelnen Bereiche direkt ueber die Sidebar.

## Warum dieses Projekt existiert

Dieses Projekt ist fuer mich eine Mischung aus:
...
Ich moechte dabei nicht nur ein funktionierendes Addon bauen, sondern auch selbst besser im Umgang mit Lua, WoW-APIs und sauberer Struktur werden.
...
- mehr Komfortfunktionen fuer den Spielalltag
...
Wenn du Feedback, Ideen oder Support dalassen moechtest:
...
Dieses Projekt befindet sich noch in einer fruehen Phase.
Es ist ein persoenliches Lern- und Entwicklungsprojekt und kann sich daher regelmaessig veraendern, erweitern oder umgebaut werden.
